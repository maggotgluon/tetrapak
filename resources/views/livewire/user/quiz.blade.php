<div class="overflow-clip max-h-svh h-full bg-[#FFF2DC]">
    ...
    <div class="h-full min-h-screen {{ isset($answer[1]) ? ' hidden' : ' block' }} flex flex-col">
        <img src="{{ asset('img/Q1-top.png') }}" class="w-11/12 -mb-20 -mt-10 z-10" />
        <div style="background: url({{ asset('img/frame.png') }}) center top; background-size:contain; background-repeat: no-repeat;"
            class="p-6 pt-12 w-3/4 m-auto flex-grow">
        ...
        <img src="{{ asset('img/Q1-bottom.png') }}" class="w-2/6 -mt-10" />
    </div>
